...
# from sklearn.cluster import DBSCAN, KMeans, OPTICS, AffinityPropagation, MeanShift, AgglomerativeClustering
...
class DepthwiseTreeBuilder:
    ...
    def build_tree(self, X, grad, hess, sample_weight=None, grad_fn=None, prev_groups = None, iter_num = None, *val_arrays):
